export const projectItems = [
  {
    ...
    descriptionDetail:
      "한세사이버보안고등학교 학생회 기능부에서 주도한 팀 프로젝트로, 시간표, 학사일정, 급식 정보, 익명 커뮤니티(대나무숲), 교내 행사 안내 등 학생 생활에 필수적인 기능을 통합한 크로스 플랫폼 모바일 애플리케이션입니다.",
    techStack: [
      "React Native, ",
      "TypeScript, ",
      "Emotion, ",
    ...
    projectImgs: ["hanum1", "hanum2", "hanum3", "hanum4"],
    contribution: [
      "한움의 프론트엔드 개발 및 서비스 배포를 담당했습니다.",
      "백엔드 서버로부터 시간표 데이터를 받아 시간표 탭을 개발했습니다.",
      "서비스 점검 모달을 개발했습니다.",
      "대나무숲 비속어 필터링 시스템을 도입했습니다.",
      "한세 음악 발표 대회 투표 기능을 추가했습니다.",
      "한움페이 중복 결제 버그를 수정했습니다.",
      "대나무숲 중복 글 작성 버그를 수정했습니다.",
      "교사용 전체 시간표 페이지를 개발 중입니다.",
    ],
  },
  {
    projectName: "Hanowl",
